...
<style>
    * {
    ...
    /* Resized the image to 80% width and centered it */
    .podiumImage {
        position: absolute;
        bottom: 0;
        left: 10%;
    ...
    @media (max-width: 680px) {
        ...
        .genLabel { padding: 6px 8px; }
    }

    @media (max-width: 630px) {
        .label { font-size: 0.9em; }
        .genLabel { font-size: 0.9em; }
    }

    @media (max-width: 610px) {
        #podium { width: 500px; height: 417px; }
        .firstLabel { bottom: 58%; }
        .secondLabel { bottom: 35%; }
        .thirdLabel { bottom: 31%; }
    }

    @media (max-width: 535px) {
        .label { font-size: 0.8em; }
        .genLabel { font-size: 0.8em; }
    }

    @media (max-width: 520px) {
        .label { font-size: 0.7em; padding: 2px 4px; }
        .genLabel { font-size: 0.7em; padding: 2px 4px; }
    }

    @media (max-width: 510px) {
        #podium { width: 400px; height: 333px; }
    }

    @media (max-width: 425px) {
        .label { font-size: 0.6em; }
        .genLabel { font-size: 0.6em; }
    }

    @media (max-width: 410px) {
        #podium { width: 300px; height: 250px; }
        .firstLabel { bottom: 53%; }
        .secondLabel { bottom: 31%; }
        .thirdLabel { bottom: 27%; }
    }

    @media (max-width: 329px) {
        .label { font-size: 0.5em; }
        .genLabel { font-size: 0.5em; }
    }
</style>
